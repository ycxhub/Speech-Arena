...
## 77. Admin languages: add 15 locales to Add Language modal [Low]

**Date & Time (IST):** 16 Mar 2026, ~8:15 PM

**Deployment notes:**
- Feature enhancements: Add 15 languages to admin Add Language dropdown (en-AU, fr-FR, de-DE, es-ES, es-MX, ta-IN, bn-IN, gu-IN, kn-IN, te-IN, ml-IN, mr-IN, pa-IN, it-IT, zh-CN)
