...
const baseUrl =
  ...
  (process.env.VERCEL_URL ? `https://${process.env.VERCEL_URL}` : "https://speecharena.com");
...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/blind-test`, lastModified: new Date(), changeFrequency: "monthly", priority: 0.8 },
